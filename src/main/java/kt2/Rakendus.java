...
/* Koosta andmebaasiliidesega veebileht, kus saab toiduaineid objektide kaudu lisada ja kustutada, nime järgi andmeid
vaadata ning rasvaprotsendivahemiku järgi otsida. Koosta lisamise, arvutamise, otsimise ja kustutamise kontrollimiseks automaattest.
 */
...
public class Rakendus {
    ...
    String lisa(String nimetus, double valgud, double rasvad, double susivesikud) throws Exception{
        String vastus = "test";
        String url = "jdbc:mysql://localhost/if17_pukkdais5?user=if17&password=if17";
...
//java -jar -Dserver.port=21213 target/daisykt2-1.0-SNAPSHOT.jar